...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo-point_add_range_sum-3.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\r\n\r\n#line\
    ...
    \                }\n                return r + 1 - size;\n            }\n    \
    \        sm = op(data[r], sm);\n        } while ((r & -r) != r);\n        return\
    \ 0;\n    }\n};\n#line 5 \"verify/yosupo-point_add_range_sum-3.test.cpp\"\n\r\n\
    int main() { IO();\r\n    int T=1;\r\n    // cin >> T;\r\n    while (T--) solve();\r\
    \n}\r\n\r\nvoid solve() {\r\n    int n, q; cin >> n >> q;\r\n    vll a(n); cin\
    \ >> a;\r\n    lazysegtree<ll,[](ll x,ll y){return x+y;},[](){return 0LL;},ll,[](ll\
    \ x,ll y){return x+y;},[](ll x,ll y){return x+y;},[](){return 0LL;}> seg(a);\r\
    \n    while (q--) {\r\n        int x, y, z; cin >> x >> y >> z;\r\n        if\
    \ (x == 0) {\r\n            seg.set(y, seg[y]+z);\r\n        } else {\r\n    \
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\r\
    ...
    \ x+y;},[](ll x,ll y){return x+y;},[](){return 0LL;}> seg(a);\r\n    while (q--)\
    \ {\r\n        int x, y, z; cin >> x >> y >> z;\r\n        if (x == 0) {\r\n \
    \           seg.set(y, seg[y]+z);\r\n        } else {\r\n            cout << seg.prod(y,\
    \ z) << nl;\r\n        }\r\n    }\r\n}"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2025-11-27 18:53:02+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo-point_add_range_sum-3.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo-point_add_range_sum-3.test.cpp
- /verify/verify/yosupo-point_add_range_sum-3.test.cpp.html
