...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo-range_affine_range_sum-1.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/range_affine_range_sum\"\r\n\r\n#line\
    ...
    \ { return (n==0 && r==0) ? 1 : C(n+r-1, r); }\n};\n#line 6 \"verify/yosupo-range_affine_range_sum-1.test.cpp\"\
    \nusing mint = modint<998244353>;\r\n\r\nint main() { IO();\r\n    int T=1;\r\n\
    \    // cin >> T;\r\n    while (T--) solve();\r\n}\r\n\r\nvoid solve() {\r\n \
    \   int n, q; cin >> n >> q;\r\n    vec<pairs<mint>> a(n, pairs<mint>{0, 1});\r\
    \n    range2(i, _, a) cin >> i;\r\n    lazysegtree<pairs<mint>, [](pairs<mint>\
    \ x, pairs<mint> y){ return pairs<mint>{x.fi+y.fi, x.se+y.se}; }, [](){ return\
    \ pairs<mint>{0, 0}; },\r\n                pairs<mint>, [](pairs<mint> x, pairs<mint>\
    \ y){ return pairs<mint>{x.fi*y.fi+x.se*y.se, y.se}; },\r\n                [](pairs<mint>\
    \ x, pairs<mint> y){ return pairs<mint>{x.fi*y.fi, x.fi*y.se+x.se}; }, [](){ return\
    \ pairs<mint>{1, 0}; }> seg(a);\r\n    while (q--) {\r\n        int x; cin >>\
    \ x;\r\n        if (x == 0) {\r\n            int l, r; mint a, b; cin >> l >>\
  ...
  requiredBy: []
  timestamp: '2025-11-27 20:35:47+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo-range_affine_range_sum-1.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo-range_affine_range_sum-1.test.cpp
- /verify/verify/yosupo-range_affine_range_sum-1.test.cpp.html
