...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo-staticrmq-2.test.cpp\"\n#define PROBLEM \"\
    ...
    \            return r + 1 - size;\n            }\n            sm = op(data[r],\
    \ sm);\n        } while ((r & -r) != r);\n        return 0;\n    }\n};\n#line\
    \ 5 \"verify/yosupo-staticrmq-2.test.cpp\"\n\r\nint main() { IO();\r\n    int\
    \ T=1;\r\n    // cin >> T;\r\n    while (T--) solve();\r\n}\r\n\r\nvoid solve()\
    \ {\r\n    int n, q; cin >> n >> q;\r\n    vi a(n); cin >> a;\r\n    segtree<int,\
  ...
  requiredBy: []
  timestamp: '2025-11-27 12:52:33+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo-staticrmq-2.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo-staticrmq-2.test.cpp
- /verify/verify/yosupo-staticrmq-2.test.cpp.html
