...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo-primality_test-1.test.cpp\"\n#define PROBLEM\
    ...
    \ re);\n    sort(re.begin(), re.end());\n    return re;\n}\n#line 5 \"verify/yosupo-primality_test-1.test.cpp\"\
    \n\r\nint main() { IO();\r\n    int T=1;\r\n    // cin >> T;\r\n    while (T--)\
    \ solve();\r\n}\r\n\r\nvoid solve() {\r\n    int q; cin >> q;\r\n    while (q--)\
    \ {\r\n        ll x; cin >> x;\r\n        YN(isprime(x));\r\n    }\r\n}\n"
  ...
  requiredBy: []
  timestamp: '2025-11-27 00:50:27+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo-primality_test-1.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo-primality_test-1.test.cpp
- /verify/verify/yosupo-primality_test-1.test.cpp.html
