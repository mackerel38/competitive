...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo-minimum_steiner_tree-1.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/minimum_steiner_tree\"\r\n\r\n#line\
    ...
    \  return res;\n}\n#line 5 \"verify/yosupo-minimum_steiner_tree-1.test.cpp\"\n\
    \r\nint main() { IO();\r\n    int T=1;\r\n    // cin >> T;\r\n    while (T--)\
    \ solve();\r\n}\r\n\r\nvoid solve() {\r\n    int n, m; cin >> n >> m;\r\n    graph<ll,\
    \ false, true> g(n);\r\n    g.read(m, 0);\r\n    int k; cin >> k;\r\n    vi a(k);\
  ...
  requiredBy: []
  timestamp: '2025-12-20 19:36:22+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo-minimum_steiner_tree-1.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo-minimum_steiner_tree-1.test.cpp
- /verify/verify/yosupo-minimum_steiner_tree-1.test.cpp.html
